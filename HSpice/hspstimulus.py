...
numBits = int(4e6)    # Number of bits needed (desired simulation length/UI)
...
countArgs=0
bitPeriod = 1/bitRate
runTime = bitPeriod*numBits
unitStep = runTime/(10*numBits)
dataPoints = runTime/unitStep
riseTime = riseTime*1e-12
